...
class TouristRetrieval:
    ...
    def _should_rebuild(self) -> bool:
        ...
        from dining_retrieval.core.index_cities import INDEX_FILTER_ID
    ...
    def _build_documents(self) -> tuple[np.ndarray, list[str], pd.DataFrame]:
        ...
        """
        from dining_retrieval.core.google_maps_loader import (
        ...
        if self.restrict_index_cities:
            from dining_retrieval.core.index_cities import INDEX_ALLOWED_CITY_STATE
            ...
            if business_df.empty:
                raise ValueError(
                    "Index city filter removed all businesses. Check `backend/dining_retrieval/core/index_cities.py` "
        ...
        from dining_retrieval.core.profile_builder import build_profile_text
