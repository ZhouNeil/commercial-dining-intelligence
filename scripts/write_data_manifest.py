#!/usr/bin/env python3
"""
Write data/manifests/active.json with relative paths, sizes, and mtimes for key data/model files.
Files under 20 MB also get sha256 (large CSVs skip hashing to save time).
